...
<input type='hidden' name='ValorI' value="<?php print $Aux_ValorI; ?>">
<input type='hidden' name='ValorD' value="<?php print $Aux_ValorD; ?>">
<input type='hidden' name='ValorT' value="<?php print $Aux_ValorT; ?>">
