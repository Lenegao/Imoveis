...
<input type='hidden' name='idEndereco' value="<?php print $Aux_idEndereco; ?>">
<input type='hidden' name='idImovel' value="<?php print $Aux_idImovel; ?>">
<input type='hidden' name='CEP' value="<?php print $Aux_CEP; ?>">
<input type='hidden' name='Numero' value="<?php print $Aux_Numero; ?>">
<input type='hidden' name='Complemento' value="<?php print $Aux_Complemento; ?>">
