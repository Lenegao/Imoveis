// Editor HTML
// http://www.mu3.com.br
// PREGO_ADN (Fernando Cruz Lopes)
// fernando_cruz_lopes@hotmail.com || fopes@comm3.com.br
...
function writeRichText(rte, html, width, height, buttons, readOnly) {
	if (isRichText) {
		...
		if (buttons == true) {
			...
			document.writeln('				<option value="<p>">Paragrafo &lt;p&gt;</option>');
			document.writeln('				<option value="<h1>">Cabecalho 1 &lt;h1&gt;</option>');
			document.writeln('				<option value="<h2>">Cabecalho 2 &lt;h2&gt;</option>');
			document.writeln('				<option value="<h3>">Cabecalho 3 &lt;h3&gt;</option>');
			document.writeln('				<option value="<h4>">Cabecalho 4 &lt;h4&gt;</option>');
			document.writeln('				<option value="<h5>">Cabecalho 5 &lt;h5&gt;</option>');
			document.writeln('				<option value="<h6>">Cabecalho 6 &lt;h6&gt;</option>');
			document.writeln('				<option value="<address>">Endereco &lt;ADDR&gt;</option>');
			document.writeln('				<option value="<pre>">Pre-Formatado &lt;pre&gt;</option>');
			...
			document.writeln('				<option value="Palatino Linotype, Book Antiqua, Palatino, serif">Palatino</option>');
			document.writeln('				<option value="Lucida Sans Unicode, Lucida Grande, sans-serif">Lucida Sans</option>');
			document.writeln('				<option value="Lucida Console, Monaco, monospace">Lucida Console</option>');
			document.writeln('				<option value="Comic Sans MS, cursive">Comic Sans MS</option>');
			document.writeln('			</select>');
			document.writeln('		</td>');
			document.writeln('		<td>');
